...
contract Encoding {
    /*
     * La proxima linea une los string
     * string(abi.encodePacked("Hi Mom! ", "Miss you."))
     * A partir de  solidity 0.8.12 puedo hacer lo siguiente y obtener el mismo resultado:
    ...
    /*
     * abi.decode(encodeString(), (string))
     * encodeString() ---> lo que voy a decodificar
     * (string) ---> lo que quiero recibir
     */
